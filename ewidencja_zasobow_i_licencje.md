...
| 6 | LangChain | Biblioteka Python | Zestaw niskopoziomowych komponentów dla modeli LLM (szablony promptów, parsery wyjść, wrappery do API). Służy jako fundament do budowy bazowych zapytań. | https://github.com/langchain-ai/langchain | MIT | https://github.com/langchain-ai/langchain/blob/master/LICENSE | @Julianna.Godziszewska |
| 7 | LangGraph | Biblioteka Python | Zaawansowany silnik orkiestracji do budowy maszyn stanowych. Wprowadza pętle, cykle decyzyjne i współdzieloną pamięć, łącząc komponenty LangChain w docelowy system wieloagentowy. | https://github.com/langchain-ai/langgraph | MIT | https://github.com/langchain-ai/langgraph/blob/main/LICENSE | @Julianna.Godziszewska |
